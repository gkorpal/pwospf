...
class CS144Topo( Topo ):
    ...
    def __init__( self, *args, **kwargs ):
        ...
        vhost1 = self.add_switch( 'vhost1' )
        vhost2 = self.add_switch( 'vhost2' )
        vhost3 = self.add_switch( 'vhost3' )
        client = self.add_host('client')

        self.add_link(client, vhost1)
        self.add_link(vhost2, vhost1)
        self.add_link(vhost3, vhost1)        
        self.add_link(server1, vhost2)
        self.add_link(server2, vhost3)
        self.add_link(vhost3, vhost2)
